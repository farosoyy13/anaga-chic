...
import OwnerRoom from './OwnerRoom'; // هذا سطر الربط
...
export default function Home() {
  ...
  return (
    <div style={{ background: '#000', color: '#d4af37', height: '100vh', padding: '20px', textAlign: 'center', fontFamily: 'Cairo, sans-serif' }}>
