...
const aiFloatBtn = { position: 'fixed', bottom: '20px', right: '20px', background: '#d4af37', border: 'none', borderRadius: '30px', padding: '15px', display: 'flex', alignItems: 'center', gap: '5px', cursor: 'pointer', zIndex: 999 };
